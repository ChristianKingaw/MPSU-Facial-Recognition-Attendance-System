...
from models import User, Student, Class, Enrollment, AttendanceRecord, FaceEncoding, VerificationCode
...
def profile():
    # Debug information
    print(f"Current user profile picture path: {current_user.profile_picture}")
    if current_user.profile_picture:
        ...
        print(f"Full path to profile picture: {full_path}")
...
@login_required
def settings():
    # Allow both admins and instructors to access settings
    if current_user.role not in ['admin', 'instructor']:
        flash('You do not have permission to access this page.', 'danger')
        return redirect(url_for('auth.login'))
    
    # Test flash message
    # flash('Test notification - Settings page loaded!', 'success')
...
def update_profile():
    if request.is_json:
        ...
        if errors:
            print("Validation failed, errors:", errors)  # Debug print
        ...
        if profile_form.validate_on_submit():
            ...
            if profile_form.new_password.data:
                # Current password is required to change password (validated by form)
    ...
    if picture_form.validate_on_submit():
        ...
        if picture_form.profile_picture.data:
            try:
                ...
                # Store the relative path from static folder using forward slashes
                ...
                print(f"Database path: {current_user.profile_picture}")
